...
@push('actions_top')
    <div class="col-auto ms-auto d-print-none">
        <div class="btn-list">
            <a href="{{route('apartments.create',$residence->id)}}" class="btn btn-primary d-none d-sm-inline-block">
                    ...
                    <div class="card">
                        <div class="card-header">
                            <ul class="nav nav-tabs card-header-tabs nav-fill" data-bs-toggle="tabs">
                                ...
                                <li class="nav-item">
                                    <a href="#tabs-apartments" class="nav-link" data-bs-toggle="tab" id="list_app">La liste des appartements de la résidence</a>
                                </li>
                            </ul>
                        </div>
                        <div class="card-body">
                            <div class="tab-content">
                                ...
                                <div class="tab-pane" id="tabs-apartments">
                                    @include('pages.apartments.index')
                                </div>
                            </div>
                        </div>
                    </div>
...
@push('js')
    <script>
        ...
        if(tabs.includes(activeTab)){
            ...
            $('#tabs-apartments').addClass('active');
            $('#tabs-apartments').addClass('show');
            $('#list_app').addClass('active');
        }
