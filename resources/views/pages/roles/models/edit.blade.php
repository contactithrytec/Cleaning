            ...
            <form action="{{route('roles.update',$role->id)}}" method="POST" enctype="multipart/form-data">
                ...
                <div class="modal-body">
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" name="name" id="name" placeholder="entrez le nom du rôle" value="{{$role->name}}">
                    </div>

                    <div class="mb-3">
                        <label class="form-label">les permissions</label>
                        <select class="form-select" id="permissions{{$role->id}}" name="permissions[]" data-placeholder="sélectionner les permissions pour ce rôle" multiple>
