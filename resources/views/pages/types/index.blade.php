...
@push('actions_top')
    <div class="col-auto ms-auto d-print-none">
        <div class="btn-list">
            ...
            <a href="#" class="btn btn-primary d-none d-sm-inline-block" data-bs-toggle="modal" data-bs-target="#modal-create_type">
...
@endpush
@include('pages.types.models.create')
@section('content')
            ...
            <div class="col-12">
                <div class="card">
                    ...
                    <div class="table-responsive">
                        <table class="table table-striped" style="width:100%" id="types_table">
                            <thead >
                            <tr>
                                <th>ID</th>
                                <th>NOM</th>
